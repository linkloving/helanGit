...
import com.linkloving.helan.logic.UI.launch.LoginInfo;
...
import com.linkloving.helan.utils.manager.OsUtils;
...
public class MyApplication extends Application{
    ...
    public final static String SERVICE_WATCH = "com.linkloving.helan";
...
//                LogX.enabled = false;
    ...
    /**
     * 启动蓝牙服务：
     * 启动服务：服务为：com.linkloving.helan.BLESERVICE
     *
     */
    public void startBleService()
    {
        ...
        serviceintent.setAction("com.linkloving.helan.BLE_SERVICE");
    ...
    /**
     * 停止蓝牙服务：
     * 停止指定的服务：com.linkloving.helan.SERVICE
     */
    public void stopBleService()
    {
        MyLog.i(TAG, "stopServices");
        Intent stopIntent =new Intent();
        stopIntent.setAction("com.linkloving.helan.BLE_SERVICE");
