 ...
 * @version 1.0
 */
package com.linkloving.helan.logic.dto;
...
public class UserBase implements Serializable
{
	...
	private String user_mail, user_mobile, nickname, user_psw, user_avatar_file_name, birthdate, longitude, latitude, register_ip, register_time, latest_login_time,
			latest_login_ip, thirdparty_access_token, thirdparty_expire_time, use_os_type, register_os_type, what_s_up,first_name,avatar_color;
...
//			latest_login_ip="", access_token="", expire_time="", use_os_type="", register_os_type="", what_s_up="";
	...
	public void setFirst_name(String firstname)
	{
		...
		if (this.propertyChangedObserver != null)
			this.propertyChangedObserver.update(null, "first_name");
	}
	...
	public void setLast_name(String last_name)
	{
		...
		if (this.propertyChangedObserver != null)
			this.propertyChangedObserver.update(null, "last_name");
	}
	...
	public void setAvatar_color(String avatar_color) {
		...
		if (this.propertyChangedObserver != null)
			this.propertyChangedObserver.update(null, "avatar_color");
	}
