package com.linkloving.helan.logic.UI.ranking;
...
import com.linkloving.helan.logic.UI.ranking.rank_fragment.Companies_list;
import com.linkloving.helan.logic.UI.ranking.rank_fragment.My_attention;
import com.linkloving.helan.logic.UI.ranking.rank_fragment.Total_list;
...
public class RankingActivity extends ToolBarActivity {
    ...
    protected void initView() {
        ...
        if (CommonUtils.isStringEmpty(ent)) {
            //有群组的时候
            TITLE = new String[]{getString(R.string.myattention), getString(R.string.ranking_all)};
            myfragment = new Fragment[2];
            myfragment[0] = new My_attention();
            myfragment[1] = new Total_list();
        } else {
            //没有群组的时候
            TITLE = new String[]{getString(R.string.myattention), getString(R.string.ranking_all), currUser.getEntEntity().getEnt_name()};
            myfragment = new Fragment[3];
            myfragment[0] = new My_attention();
            myfragment[1] = new Total_list();
            myfragment[2] = new Companies_list();
        }
