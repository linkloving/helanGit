...
import com.VitaBit.VitaBit.logic.UI.launch.LoginInfo;
import com.VitaBit.VitaBit.logic.dto.EntEntity;
import com.VitaBit.VitaBit.logic.dto.SportDeviceEntity;
...
public class MyApplication extends Application{
    ...
    public final static String SERVICE_WATCH = "com.VitaBit.VitaBit";
    ...
    public void setILifecycle(ILifecycle lifecycle){
...
//                        MyLog.i(TAG,"onActivityCreated");
                    ...
                    public void onActivityStarted(Activity activity) {
                        ...
                        if(activityCount==0){
                            MyLog.i(TAG,">>>>>>>>>>>>>>>>>>>切到前台  lifecycle");
                            if(lifecycle!=null)
                                lifecycle.back2Foreground();
                        }
                        activityCount++;
                    }
...
//                LogX.enabled = false;
    ...
    /**
     * 启动蓝牙服务：
     * 启动服务：服务为：com.VitaBit.VitaBit.BLESERVICE
     *
     */
    public void startBleService()
    {
        ...
        serviceintent.setAction("com.VitaBit.VitaBit.BLE_SERVICE");
    ...
    /**
     * 停止蓝牙服务：
     * 停止指定的服务：com.VitaBit.VitaBit.SERVICE
     */
    public void stopBleService()
    {
        MyLog.i(TAG, "stopServices");
        Intent stopIntent =new Intent();
        stopIntent.setAction("com.VitaBit.VitaBit.BLE_SERVICE");
