...
import com.VitaBit.VitaBit.basic.EditPopWindow;
...
import com.VitaBit.VitaBit.logic.UI.launch.dto.UserTypeConst;
...
public class RegisterActivity extends Activity implements View.OnClickListener {
    ...
    com.VitaBit.VitaBit.logic.UI.launch.dto.UserRegisterDTO registerData;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(com.VitaBit.VitaBit.R.layout.activity_register);
        AppManager.getAppManager().addActivity(this);
        layout = (RelativeLayout) findViewById(com.VitaBit.VitaBit.R.id.layout);
        layout.setOnClickListener(this);
        txtEmail = (EditText) this.findViewById(com.VitaBit.VitaBit.R.id.register_form_emailEdit);
        txtPassword = (EditText) this.findViewById(com.VitaBit.VitaBit.R.id.register_form_passwordEdit);
        txtConformPassword = (EditText) this.findViewById(com.VitaBit.VitaBit.R.id.register_form_conformPswEdit);
        cbAgreeLisence_1 = (TextView) this.findViewById(com.VitaBit.VitaBit.R.id.register_form_agreeLisenseCb_1);
        cbAgreeLisence_2 = (TextView) this.findViewById(com.VitaBit.VitaBit.R.id.register_form_agreeLisenseCb_2);
        cbAgreeLisence_3 = (TextView) this.findViewById(com.VitaBit.VitaBit.R.id.register_form_agreeLisenseCb_3);
        cbAgreeLisence_4 = (TextView) this.findViewById(com.VitaBit.VitaBit.R.id.register_form_agreeLisenseCb_4);
        cbAgreeLisence_2.setOnClickListener(this);
        cbAgreeLisence_4.setOnClickListener(this);
            cbAgreeLisence_1.setText(this.getString(com.VitaBit.VitaBit.R.string.register_agreelisenc_1));
            cbAgreeLisence_2.setText(Html.fromHtml("<u>"+this.getString(com.VitaBit.VitaBit.R.string.register_agreelisenc_2)+"</u>"));
            cbAgreeLisence_3.setText(this.getString(com.VitaBit.VitaBit.R.string.register_agreelisenc_3));
            cbAgreeLisence_4.setText(Html.fromHtml("<u>"+this.getString(com.VitaBit.VitaBit.R.string.register_agreelisenc_4)+"</u>"));
        btnNext = (Button) this.findViewById(com.VitaBit.VitaBit.R.id.register_form_submitBtn);
        btnNext.setOnClickListener(this);
        popupWindow = EditPopWindow.createPopupWindow(this, com.VitaBit.VitaBit.R.layout.popup_reg_view, ViewGroup.LayoutParams.WRAP_CONTENT,ViewGroup.LayoutParams.WRAP_CONTENT, false);
        //判断输入的邮箱号是否符合要求
    ...
    private boolean emailInvild() {
        if (String.valueOf(txtEmail.getText()).trim().length() <= 0) {
            ...
            popupWindow.setText(popupWindow,getString(com.VitaBit.VitaBit.R.string.login_error7));
            return false;
        }
        if (!CommonUtils.isEmail(String.valueOf(txtEmail.getText()).trim())) {
            popupWindow.showAsDropDown(txtEmail);
            popupWindow.setText(popupWindow,getString(com.VitaBit.VitaBit.R.string.login_error2));
            return false;
        }
        return true;
    }
    ...
    private boolean checkfirstPassword()
    {
        ...
        if (CommonUtils.isStringEmpty(firstPsw))
        {
            ...
            popupWindow.setText(popupWindow,getString(com.VitaBit.VitaBit.R.string.register_form_valid_psw));
            return false;
        }
        // 新密码长度是否大于6
        ...
        {
            popupWindow.showAsDropDown(txtPassword);
            popupWindow.setText(popupWindow,getString(com.VitaBit.VitaBit.R.string.register_form_valid_psw_notenouph));
            return false;
        }
        return true;
    }
    ...
    private boolean checkSecondPassword()
    {
        ...
        {
            popupWindow.showAsDropDown(txtConformPassword);
            popupWindow.setText(popupWindow,getString(com.VitaBit.VitaBit.R.string.register_form_valid_psw_not_same));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case com.VitaBit.VitaBit.R.id.layout:
                break;
            case com.VitaBit.VitaBit.R.id.register_form_agreeLisenseCb_2:
//              跳转到服务条款
                ...
                break;
            case com.VitaBit.VitaBit.R.id.register_form_agreeLisenseCb_4:
//              跳转到服务条款
                ...
                break;
            case com.VitaBit.VitaBit.R.id.register_form_submitBtn:
    ...
    public com.VitaBit.VitaBit.logic.UI.launch.dto.UserRegisterDTO getFormData() {
        com.VitaBit.VitaBit.logic.UI.launch.dto.UserRegisterDTO u = new com.VitaBit.VitaBit.logic.UI.launch.dto.UserRegisterDTO();
...
//    }
    private void Submit_RegisteredInfo() {
        if (MyApplication.getInstance(RegisterActivity.this).isLocalDeviceNetworkOk()) {
            ...
            CallServer.getRequestInstance().add(this, getString(com.VitaBit.VitaBit.R.string.general_submitting), CommParams.HTTP_REGISTERED_EMAIL, NoHttpRuquestFactory.submit_RegisterationToServer(registerData), httpCallbackSubmit);
        } else
        ...
        public void onSucceed(int what, Response<String> response) {
            ...
            switch (what) {
                case CommParams.HTTP_REGISTERED_EMAIL:
                    if (dataFromServer.getErrorCode() == 1) {
                        ...
                        switch (dataFromServer.getErrorCode()){
                            case 10003:
                                MyToast.show(RegisterActivity.this, getString(com.VitaBit.VitaBit.R.string.register_form_mail_have_exist), Toast.LENGTH_LONG);
                                break;
                        }
                    }
                    break;
                case CommParams.HTTP_CHECK_IS_REGISTER:
                    ...
                    if(!mailValid){
                        popupWindow.showAsDropDown(txtEmail);
                        popupWindow.setText(popupWindow,getString(com.VitaBit.VitaBit.R.string.register_form_mail_have_exist));
                    }
            }
        }
