package com.VitaBit.VitaBit.logic.UI.more;
...
import com.VitaBit.VitaBit.logic.UI.launch.GoActivity;
...
import com.VitaBit.VitaBit.utils.HttpUtils;
...
public class MoreActivity extends ToolBarActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.VitaBit.VitaBit.R.layout.activity_more);
    ...
    protected void initView() {
        SetBarTitleText(getString(com.VitaBit.VitaBit.R.string.general_more));
        more_unit = (LinearLayout) findViewById(com.VitaBit.VitaBit.R.id.activity_more_unit_settings);
        tv_more_unit = (TextView) findViewById(com.VitaBit.VitaBit.R.id.tv_more_unit);
        tv_more_verson = (TextView) findViewById(com.VitaBit.VitaBit.R.id.tv_more_verson);
        privacy = (LinearLayout) findViewById(com.VitaBit.VitaBit.R.id.activity_more_privacy);
        activity_more_start = (LinearLayout) findViewById(com.VitaBit.VitaBit.R.id.activity_more_start);
        activity_more_device = (LinearLayout) findViewById(com.VitaBit.VitaBit.R.id.activity_more_device);
        activity_more_Cloud_Sync = (LinearLayout) findViewById(com.VitaBit.VitaBit.R.id.activity_more_Cloud_Sync);
        relogin = (LinearLayout) findViewById(com.VitaBit.VitaBit.R.id.activity_more_relogin);
        exitApp = (LinearLayout) findViewById(com.VitaBit.VitaBit.R.id.activity_more_exit);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case com.VitaBit.VitaBit.R.id.activity_more_start:
                //跳转到入门指南界面
                Intent intentGuide = new Intent(MoreActivity.this, GuideActivity.class);
                startActivity(intentGuide);
                break;
            case com.VitaBit.VitaBit.R.id.activity_more_privacy:
                startActivity(IntentFactory.createCommonWebActivityIntent(this, HttpHelper.Private_Policy));
                break;
            case com.VitaBit.VitaBit.R.id.activity_more_device:
                startActivity(IntentFactory.star_DeviceActivityIntent(this,0));
                break;
            case com.VitaBit.VitaBit.R.id.activity_more_unit_settings:
                LayoutInflater inflater = getLayoutInflater();
                View layoutbund =inflater.inflate(com.VitaBit.VitaBit.R.layout.modify_sex_dialog, (ViewGroup)findViewById(com.VitaBit.VitaBit.R.id.linear_modify_sex));
                final RadioButton metric_system= (RadioButton) layoutbund.findViewById(com.VitaBit.VitaBit.R.id.rb_left);
                metric_system.setText(getString(com.VitaBit.VitaBit.R.string.metric_system));
                final RadioButton more_inch=(RadioButton) layoutbund.findViewById(com.VitaBit.VitaBit.R.id.rb_right);
                more_inch.setText(getString(com.VitaBit.VitaBit.R.string.more_inch));
                AlertDialog dialogunit = new AlertDialog.Builder(MoreActivity.this)
                        .setTitle(ToolKits.getStringbyId(MoreActivity.this, com.VitaBit.VitaBit.R.string.unit_settings))
                        .setView(layoutbund)
                        .setPositiveButton(ToolKits.getStringbyId(MoreActivity.this, com.VitaBit.VitaBit.R.string.general_ok),
                        ...
                        .setNegativeButton(ToolKits.getStringbyId(MoreActivity.this, com.VitaBit.VitaBit.R.string.general_cancel), null)
                        .create();
                dialogunit.show();
                break;
            case com.VitaBit.VitaBit.R.id.activity_more_Cloud_Sync:
                AlertDialog dialog = new AlertDialog.Builder(MoreActivity.this)
                        .setTitle(ToolKits.getStringbyId(MoreActivity.this, com.VitaBit.VitaBit.R.string.main_more_sycn_title))
                        .setMessage(ToolKits.getStringbyId(MoreActivity.this, com.VitaBit.VitaBit.R.string.main_more_sycn_message))
                        .setPositiveButton(ToolKits.getStringbyId(MoreActivity.this, com.VitaBit.VitaBit.R.string.general_yes),
                                new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        .setNegativeButton(ToolKits.getStringbyId(MoreActivity.this, com.VitaBit.VitaBit.R.string.general_no), null)
                        .create();
                dialog.show();
                break;
            case com.VitaBit.VitaBit.R.id.activity_more_relogin:
                    new AlertDialog.Builder(MoreActivity.this)  //
                            .setTitle(getString(com.VitaBit.VitaBit.R.string.login_form_relogin_text))
            ...
            case com.VitaBit.VitaBit.R.id.activity_more_exit:
    ...
    public static void ExitApp(final Context context) {
        new AlertDialog.Builder(context)  //
                .setTitle(context.getString(com.VitaBit.VitaBit.R.string.menu_exit))
                .setPositiveButton(context.getString(com.VitaBit.VitaBit.R.string.general_yes), new DialogInterface.OnClickListener() {
                ...
                }).setNegativeButton(context.getString(com.VitaBit.VitaBit.R.string.general_cancel), null)
                .show();
    }
            ...
            switch (what){
                case CommParams.REQUEST_GET_GROUP:
                    ...
                    if (dataFromServer.getErrorCode()==1&&!CommonUtils.isStringEmpty(value)) {
                        ...
                        MyToast.show(MoreActivity.this, getString(com.VitaBit.VitaBit.R.string.main_more_exit_ent_success), Toast.LENGTH_SHORT);
                        finish();
                    }
                    break;
                            ...
                            new AsyncTask<Object, Object, Boolean>() {
                                ...
                                protected void onPostExecute(Boolean result) {
                                    if(progressDialog.isShowing())
                                        progressDialog.dismiss();
                                    new AlertDialog.Builder(MoreActivity.this)  //
                                            .setTitle(getString(com.VitaBit.VitaBit.R.string.main_more_sync_end))
                                            .setPositiveButton(getString(com.VitaBit.VitaBit.R.string.general_yes), null)
                                            .show();
                                }
                            }.execute();
                        }
    ...
    private void initData() {
        ...
        if(PreferencesToolkits.getLocalSettingUnitInfo(this)==ToolKits.UNIT_GONG){
            tv_more_unit.setText(getString(com.VitaBit.VitaBit.R.string.metric_system));
        }else{
            tv_more_unit.setText(getString(com.VitaBit.VitaBit.R.string.more_inch));
        }
    }
    ...
    private ProgressDialog initDialog() {
        ...
        progressDialog.setTitle(getString(com.VitaBit.VitaBit.R.string.main_more_sycing));
