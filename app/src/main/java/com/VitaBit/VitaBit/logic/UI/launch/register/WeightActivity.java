...
import com.VitaBit.VitaBit.logic.UI.launch.view.ScaleRulerView;
...
public class WeightActivity extends ToolBarActivity {
    ...
    Button next;
    @InjectView(com.VitaBit.VitaBit.R.id.scaleWheelView_weight)
    ScaleRulerView mWeightWheelView;
    @InjectView(com.VitaBit.VitaBit.R.id.tv_user_weight_value)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.VitaBit.VitaBit.R.layout.activity_weight_register);
