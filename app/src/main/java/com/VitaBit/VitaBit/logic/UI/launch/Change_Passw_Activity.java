...
import com.VitaBit.VitaBit.logic.UI.launch.register.ForgetPassWordMainActivity;
...
public class Change_Passw_Activity extends Activity implements View.OnClickListener, View.OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.VitaBit.VitaBit.R.layout.login_from_message);
    ...
    private void initView(){
        ...
        phoneNum= (EditText) findViewById(com.VitaBit.VitaBit.R.id.phone_number);
        login_erification_code= (EditText) findViewById(com.VitaBit.VitaBit.R.id.login_erification_code);
        sendMessage= (Button) findViewById(com.VitaBit.VitaBit.R.id.send_message);
...
//        }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case com.VitaBit.VitaBit.R.id.send_message:
                if(MyApplication.getInstance(this).isLocalDeviceNetworkOk()){
                    ...
                    MyToast.show(Change_Passw_Activity.this, getString(com.VitaBit.VitaBit.R.string.main_more_sycn_fail), Toast.LENGTH_LONG);
                }
                break;
    ...
    private boolean checkCode(){
        if((String.valueOf(login_erification_code.getText())).trim().length()!=4){
            popupWindow.showAsDropDown(phoneNum);
            popupWindow.setText(popupWindow,getString(com.VitaBit.VitaBit.R.string.login_error9));
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        sendMessage.setBackground(getBaseContext().getResources().getDrawable(com.VitaBit.VitaBit.R.drawable.textview_black));
        break;
        case com.VitaBit.VitaBit.R.id.login_erification_code:

        supportCountry.setBackground(ContextCompat.getDrawable(Change_Passw_Activity.this, com.VitaBit.VitaBit.R.drawable.textview_black));
        sendMessage.setBackground(ContextCompat.getDrawable(Change_Passw_Activity.this, com.VitaBit.VitaBit.R.drawable.textview_orange));
        break;
     }
        return false;
    }
    ...
    public void showDialog(final String phone, final String code) {
        ...
        builder.setMessage(getString(com.VitaBit.VitaBit.R.string.send_confirm)+"+" + code+" " + phone);

        builder.setTitle(getString(com.VitaBit.VitaBit.R.string.smssdk_make_sure_mobile_num));

        builder.setPositiveButton(getString(com.VitaBit.VitaBit.R.string.queren), new DialogInterface.OnClickListener() {
        ...
        builder.setNegativeButton(getString(com.VitaBit.VitaBit.R.string.general_cancel), new DialogInterface.OnClickListener() {
    ...
    private void countDown() {
        ...
        new CountDownTimer(60000,1000){
            ...
            public void onTick(long millisUntilFinished) {
                ...
                sendMessage.setText(millisUntilFinished / 1000 + getString(com.VitaBit.VitaBit.R.string.unit_second));
            }

            @Override
            public void onFinish() {

                sendMessage.setText(getString(com.VitaBit.VitaBit.R.string.smssdk_resend_identify_code));
