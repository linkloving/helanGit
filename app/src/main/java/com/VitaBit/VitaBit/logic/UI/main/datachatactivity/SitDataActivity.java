 ...
 */
public class SitDataActivity extends ToolBarActivity implements View.OnClickListener,RadioGroup.OnCheckedChangeListener{
    private static final String TAG = SitDataActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.VitaBit.VitaBit.R.layout.activity_sleep_data);
    ...
    private void setDataToView(int position,List<DaySynopic> daySynopicList){
        if(dayButton.isChecked()){
            ...
            TextView data= (TextView) view.findViewById(com.VitaBit.VitaBit.R.id.data);
            ...
            if(daySynopicList==null || daySynopicList.size()<=0 ){
                ...
                double sitDuration = CommonUtils.getScaledDoubleValue(Double.valueOf(daySynopicList.get(0).getSitTime()), 1);
                ...
                if(sitDuration==0){
                    ...
                    data.setText(nf.format(sitDuration)+ " ");
                }
            }
        }
        else
        {
            ...
            TextView dataTitle= (TextView) view.findViewById(com.VitaBit.VitaBit.R.id.data_count_title);
            ...
            if(daySynopicList!=null && daySynopicList.size()>0){
                ...
                for(DaySynopic mDaySynopic : daySynopicList){
                    ...
                    double sitDuration = CommonUtils.getScaledDoubleValue(Double.valueOf(mDaySynopic.getSitTime()), 1);
                    count += sitDuration;
                }
                if(count==0){
                    shuju.setVisibility(View.GONE);
                    ...
                    shuju.setVisibility(View.VISIBLE);
                    nulldata.setVisibility(View.GONE);
                    dataTitle.setText(getString(com.VitaBit.VitaBit.R.string.count_title));
                    data.setText(nf.format(count) + "");//getString(R.string.unit_minute)
                    MyLog.e(TAG,"=====----------=======");
                    MySleepAdapter adapter=new MySleepAdapter(SitDataActivity.this, (ArrayList<DaySynopic>) daySynopicList);
    ...
    public class MySleepAdapter extends BaseAdapter {
        ...
        private void initlist  (){
            for(DaySynopic d:list){
                double sitDuration = CommonUtils.getScaledDoubleValue(Double.valueOf(d.getSitTime()), 1);
                MyLog.e(TAG,"汇总数据："+d.toString());
                double count = sitDuration;
                if(count != 0){
                    mlist.add(d);
                }
            }
...
//            });
            ...
            vh.unit_step.setText(getString(com.VitaBit.VitaBit.R.string.unit_minute));
            //运动目标
    ...
    protected void initView() {
        SetBarTitleText(getString(com.VitaBit.VitaBit.R.string.detail_sit_title));
        ...
        dayButton= (RadioButton) findViewById(com.VitaBit.VitaBit.R.id.sleep_page_activity_circleviews_dayRb);
        weekButton= (RadioButton) findViewById(com.VitaBit.VitaBit.R.id.sleep_page_activity_circleviews_weekRb);
        monthButton= (RadioButton) findViewById(com.VitaBit.VitaBit.R.id.sleep_page_activity_circleviews_monthRb);
        leftDay=(RadioButton) findViewById(com.VitaBit.VitaBit.R.id.day01);
        middleDay=(RadioButton) findViewById(com.VitaBit.VitaBit.R.id.day02);
        rightDay=(RadioButton) findViewById(com.VitaBit.VitaBit.R.id.day03);
        mViewPager= (ViewPager) findViewById(com.VitaBit.VitaBit.R.id.my_ViewPager);
        ViewUtils.initDayChat(SitDataActivity.this,combbarChart);
    }
...
//        addline(R.id.report_page_activity_circleviews_dayRb);
        ...
        dataSet.setColors(ViewUtils.getChartColors(SitDataActivity.this)); //设置多种颜色
    ...
    private BarData getWeekBarData() {
        ...
        for(int i=0;i<listData.size();i++){
            ...
            c.setTime(date);
            //计算站立时间
            double sitDuration = CommonUtils.getScaledDoubleValue(Double.valueOf(listData.get(i).getSitTime()), 1);
            if((c.get(Calendar.DAY_OF_WEEK) - 1)==0){
                entries.add(new BarEntry((float) sitDuration, 6));
            }else {
                entries.add(new BarEntry((float) sitDuration, c.get(c.DAY_OF_WEEK)-2));
            }
        }
        mentries=entries;
//        addLimitline(R.id.report_page_activity_circleviews_weekRb);
        BarDataSet dataSet =ViewUtils.getDataSet(SitDataActivity.this,entries);
        bardata.addDataSet(dataSet);
        return bardata;
    }
    //获取月数据
    private BarData getMonthBarData() {
        ...
        for(int i=0;i<listData.size();i++){
            ...
            double sitDuration = CommonUtils.getScaledDoubleValue(Double.valueOf(listData.get(i).getSitTime()), 1);
            entries.add(new BarEntry((float) sitDuration,dayInt));
        }
        mentries=entries;
//        addLimitline(R.id.report_page_activity_circleviews_weekRb);
        BarDataSet dataSet =ViewUtils.getDataSet(SitDataActivity.this,entries);
    ...
    private void addLimitline(int i){
        ...
        switch (i){
            ...
            case com.VitaBit.VitaBit.R.id.report_page_activity_circleviews_monthRb:
                ...
                MyLog.e(TAG, yAxis.getAxisMaxValue() + "最大值");
                LimitLine limitMonth = new LimitLine(100,f/2+"");
                limitMonth.setLineColor(Color.WHITE);
                limitMonth.setLineWidth(1f);
                limitMonth.setTextColor(Color.WHITE);
                limitMonth.setTextSize(12f);
                limitMonth.setLabelPosition(LimitLine.LimitLabelPosition.LEFT_TOP);
                yAxis.addLimitLine(limitMonth);
                break;
        }
    }
    ...
    private void changePageTitle(int position){
        ...
        if(dayButton.isChecked()){
            ...
            if(day==0){
                //传进来的是今天的数据
                leftDay.setText(getString(com.VitaBit.VitaBit.R.string.yesterday));
                middleDay.setText(getString(com.VitaBit.VitaBit.R.string.today));
                ...
                middleDay.setText(getString(com.VitaBit.VitaBit.R.string.yesterday));
                middleDay.setChecked(true);
                rightDay.setText(getString(com.VitaBit.VitaBit.R.string.today));
            }else if(day==2){
                ...
                rightDay.setText(getString(com.VitaBit.VitaBit.R.string.yesterday));
            }
            else{
        ...
        //周数据
            ...
            if(weekcount-position-1==0){
                //传进来的是本周
                // 上周  本周
                leftDay.setText(getString(com.VitaBit.VitaBit.R.string.lastweek));
                middleDay.setText(getString(com.VitaBit.VitaBit.R.string.thisweek));
                middleDay.setChecked(true);
                rightDay.setText("");
            }
                ...
                middleDay.setText(getString(com.VitaBit.VitaBit.R.string.lastweek));
                middleDay.setChecked(true);
                rightDay.setText(getString(com.VitaBit.VitaBit.R.string.thisweek));
                ...
                rightDay.setText(getString(com.VitaBit.VitaBit.R.string.lastweek));
        ...
        //月数据
            ...
            if(position==month-1){
                //传进来的是本月的数据
                //当前是本月
                leftDay.setText(getString(com.VitaBit.VitaBit.R.string.lastmonth));
                middleDay.setText(getString(com.VitaBit.VitaBit.R.string.thismonth));
                middleDay.setChecked(true);
                rightDay.setText("");
                ...
                leftDay.setText(s);
                middleDay.setText(getString(com.VitaBit.VitaBit.R.string.lastmonth));
                middleDay.setChecked(true);
                rightDay.setText(getString(com.VitaBit.VitaBit.R.string.thismonth));
                ...
                middleDay.setChecked(true);
                rightDay.setText(getString(com.VitaBit.VitaBit.R.string.lastmonth));
            }else{
                //相差了month-position-1
                GregorianCalendar base1= new GregorianCalendar();
                base1.setTime(new Date());
    ...
    private void changeChat(final int position){
        ...
        if(dayButton.isChecked()){
            ...
            AsyncTask myDayAsync=new AsyncTask<Object,Object,List<DaySynopic>>(){
                ...
                protected List<DaySynopic> doInBackground(Object... params) {
                    ...
                    if(days - position - 1 == 0){ //这是今天
                        if(hourSelectPosition == Datahelper.TYPE_3H){       //若用户选择3H类型
                            ...
                            //构建数据集
                            sportRecords = new Datahelper(SitDataActivity.this, String.valueOf(userEntity.getUser_id()), startTime, endTime, Datahelper.TYPE_3H).getSportRecords();
                            ...
                            sportRecords = new Datahelper(SitDataActivity.this, String.valueOf(userEntity.getUser_id()), startTime, endTime, Datahelper.TYPE_8H).getSportRecords();
                            ...
                            sportRecords = new Datahelper(SitDataActivity.this, String.valueOf(userEntity.getUser_id()), startTime, endTime, Datahelper.TYPE_24H).getSportRecords();
                        }
                    }else{//不是今天只显示24h的
                        hourSelectPosition =  Datahelper.TYPE_24H;
                        startTime = new SimpleDateFormat(ToolKits.DATE_FORMAT_YYYY_MM_DD).format(dateNow);
                    ...
                    //查询汇总表的数据
                    List<DaySynopic> mDaySynopicArrayList= DaySynopicTable.findDaySynopicRange(SitDataActivity.this, userEntity.getUser_id()+"", time, time, String.valueOf(TimeZoneHelper.getTimeZoneOffsetMinute()));
                    ...
                    if(mDaySynopicArrayList==null||mDaySynopicArrayList.size()<=0){
                        mDaySynopic= SportDataHelper.offlineReadMultiDaySleepDataToServer(SitDataActivity.this, time, time);
                        if(mDaySynopic.getTime_zone()==null){
                            //没有这一天的数据
                        }else {
                            temp.add(mDaySynopic);
                            DaySynopicTable.saveToSqliteAsync(SitDataActivity.this,temp,userEntity.getUser_id()+"");
                        }
                    }else {
                ...
                protected void onPostExecute(List<DaySynopic> aVoid) {
                    ...
                    ViewUtils.initXAxis(SitDataActivity.this,combbarChart,hourSelectPosition);
        ...
        if(weekButton.isChecked()){
            ...
            AsyncTask myWeekAsync=new AsyncTask<Object,Object,Object>(){
                ...
                protected Object doInBackground(Object... params) {
                    ...
                    ArrayList<DaySynopic> mDaySynopicArrayList=ToolKits.getFindWeekData(SitDataActivity.this,weekSwitcher.getStartDate(),userEntity);
                ...
                protected void onPostExecute(Object aVoid) {
                    ...
                    ViewUtils.initXAxis(SitDataActivity.this,combbarChart,0);
        ...
        if(monthButton.isChecked()){
            ...
            AsyncTask myMonthAsybc=new AsyncTask<Object,Object,Object>(){
                ...
                protected Object doInBackground(Object... params) {
                    MyLog.e(TAG, "开始时间=" + new SimpleDateFormat(ToolKits.DATE_FORMAT_YYYY_MM_DD_HH_MM_SS).format(new Date()));
                    ArrayList<DaySynopic> mDaySynopicArrayList=ToolKits.getFindMonthData(SitDataActivity.this,monthSwitcher.getStartDate(),userEntity);
                    listData=mDaySynopicArrayList;
                    return null;
                }
                @Override
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case com.VitaBit.VitaBit.R.id.sleep_page_activity_circleviews_dayRb:
                if(dayButton.isChecked()){
                    chart_hour_layout.setVisibility(View.VISIBLE);
                    initTitle();
                }
                break;
            case com.VitaBit.VitaBit.R.id.sleep_page_activity_circleviews_weekRb:
                if(weekButton.isChecked()){
                    chart_hour_layout.setVisibility(View.GONE);
                    initTitle();
                }
                break;
            case com.VitaBit.VitaBit.R.id.sleep_page_activity_circleviews_monthRb:
                if(monthButton.isChecked()){
                    chart_hour_layout.setVisibility(View.GONE);
                    initTitle();
                }
