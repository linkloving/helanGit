 ...
 */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflateAndSetupView(inflater, container, savedInstanceState, com.VitaBit.VitaBit.R.layout.fragment_find_friend);
        ...
        View layout = inflater.inflate(layoutResourceId, container, false);
            ...
            find= (Button) layout.findViewById(com.VitaBit.VitaBit.R.id.search_btn);

            find.setOnClickListener(this);

            search_content= (EditText) layout.findViewById(com.VitaBit.VitaBit.R.id.search_content);
...
//            ArrayList<UserBase> temp = (ArrayList<UserBase>) JSON.parseArray(value, UserBase.class);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case com.VitaBit.VitaBit.R.id.search_btn:
                ...
                if(condition == null || condition.isEmpty())
                {
                    ...
                    MyToast.showShort(getContext(),getString(com.VitaBit.VitaBit.R.string.relationship_search_condition_empty));
    ...
    public class SearchAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            if(viewType==TYPE_ITEM){
                ...
                View view=mInflater.inflate(com.VitaBit.VitaBit.R.layout.list_item_search,parent,false);
                ...
                View foot_view=mInflater.inflate(com.VitaBit.VitaBit.R.layout.recycler_load_more_layout,parent,false);
...
//                            .showImageOnFail(R.mipmap.default_avatar)//加载失败显示图片
                    ...
                    ImageLoader.getInstance().displayImage(url, itemViewHolder.head, options, new ImageLoadingListener() {
                        ...
                        public void onLoadingFailed(String imageUri, View view, FailReason failReason) {
                            ...
                            if(list.get(position).getUser_sex()==0){
                                //女生
                                itemViewHolder.head.setImageResource(com.VitaBit.VitaBit.R.mipmap.default_avatar_f);
                            }else {
                                //男生
                                itemViewHolder.head.setImageResource(com.VitaBit.VitaBit.R.mipmap.default_avatar_m);
                            }
                        }
        ...
        public  class ItemViewHolder extends RecyclerView.ViewHolder {
            ...
            public ItemViewHolder(View itemView) {
                super(itemView);
                search= (LinearLayout) itemView.findViewById(com.VitaBit.VitaBit.R.id.linear_search);
                 head = (ImageView) itemView.findViewById(com.VitaBit.VitaBit.R.id.user_head);
                 label = (TextView) itemView.findViewById(com.VitaBit.VitaBit.R.id.search_label);
                 nickName = (TextView) itemView.findViewById(com.VitaBit.VitaBit.R.id.search_nickName);
