...
public class BoundActivity extends ToolBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.VitaBit.VitaBit.R.layout.activity_bound);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_BLE_LIST) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                ToolKits.showCommonTosat(BoundActivity.this, false, ToolKits.getStringbyId(BoundActivity.this, com.VitaBit.VitaBit.R.string.bound_failed_reason), Toast.LENGTH_LONG);
