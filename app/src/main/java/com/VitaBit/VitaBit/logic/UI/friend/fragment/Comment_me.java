...
//                    保存到本地  判断是否存过  存过直接忽略
                        ...
                        PreferencesToolkits.saveComment(getContext(), JSON.toJSONString(list));
                        adapter = new CimmentMeAdapter(getContext(), list);
    ...
    private class CimmentMeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            View view = mInflater.inflate(com.VitaBit.VitaBit.R.layout.list_item_comments, parent, false);
            ...
            if(date!=null){
                ...
                switch (i){
                    case 0:
                        ...
                        break;
                    case 1:
                        itemViewHolder.last_time.setText(getString(com.VitaBit.VitaBit.R.string.yesterday));
                        break;
                    default:
        ...
        public class ItemViewHolder extends RecyclerView.ViewHolder {
            ...
            public ItemViewHolder(View view) {
                super(view);
                message = (RelativeLayout) view.findViewById(com.VitaBit.VitaBit.R.id.linear_message);
//                quname = (TextView) view.findViewById(R.id.nickqunname);//群组的
                last_content = (TextView) view.findViewById(com.VitaBit.VitaBit.R.id.comment);//评论的内容
                last_time = (TextView) view.findViewById(com.VitaBit.VitaBit.R.id.time);//评论的时间
                user_avatar_file_name = (ImageView) view.findViewById(com.VitaBit.VitaBit.R.id.head);//头像
                nickName = (TextView) view.findViewById(com.VitaBit.VitaBit.R.id.nickName);//昵称
                unRead = (TextView) view.findViewById(com.VitaBit.VitaBit.R.id.comments_item_unread_text);//未读的消息数
            }
        }
