...
public class BodyActivity extends ToolBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.VitaBit.VitaBit.R.layout.activity_body);
    ...
    protected void initView() {
        //设置标题
        SetBarTitleText(getString(com.VitaBit.VitaBit.R.string.body_activity));
//        et_target_step = (EditText) findViewById(R.id.et_target_step);
        reduceHeight = (LinearLayout) findViewById(com.VitaBit.VitaBit.R.id.body_info_reduceHieght);
        plusHeight = (LinearLayout) findViewById(com.VitaBit.VitaBit.R.id.body_info_plusHeight);
        reduceWeight = (LinearLayout) findViewById(com.VitaBit.VitaBit.R.id.body_info_reduceWieght);
        plusWeight = (LinearLayout) findViewById(com.VitaBit.VitaBit.R.id.body_info_plusWeight);
        reduceAge = (LinearLayout) findViewById(com.VitaBit.VitaBit.R.id.body_info_reduceAge);
        plusAge = (LinearLayout) findViewById(com.VitaBit.VitaBit.R.id.body_info_plusAge);

        et_userAge = (EditText) findViewById(com.VitaBit.VitaBit.R.id.et_userAge);
        et_userHeight = (EditText) findViewById(com.VitaBit.VitaBit.R.id.et_userHeight);
        et_userWeight = (EditText) findViewById(com.VitaBit.VitaBit.R.id.et_userWeight);
        et_userHeight.setText("170");
        et_userWeight.setText("60");
        et_userAge.setText("35");
        womanCb = (RadioButton) findViewById(com.VitaBit.VitaBit.R.id.body_info_womanCb);
        manCb = (RadioButton) findViewById(com.VitaBit.VitaBit.R.id.body_info_manCb);
        mButton = (Button) findViewById(com.VitaBit.VitaBit.R.id.body_info_save_btn);
            ...
            public void onClick(View v) {
                ...
                if (checkBodyInfo()) {
                    ...
                    if (Integer.parseInt(et_userAge.getText().toString()) < 12 || Integer.parseInt(et_userAge.getText().toString()) > 114) {
                        Toast.makeText(getApplicationContext(), getString(com.VitaBit.VitaBit.R.string.body_info_age_recommend), Toast.LENGTH_SHORT).show();
                    } else {
                        String sex = null;
                        if (manCb.isChecked()) {
                            sex = "1";
...
//
                        ...
                        if (MyApplication.getInstance(BodyActivity.this).isLocalDeviceNetworkOk()) {
                            //网络交互：提交目标数据
                            CallServer.getRequestInstance().add(BodyActivity.this, getString(com.VitaBit.VitaBit.R.string.general_submitting), CommParams.HTTP_SUBMIT_BODYDATA, NoHttpRuquestFactory.submit_RegisterationToServer_Modify(userbase), httpCallback);
                        } else
                            ToolKits.showCommonTosat(BodyActivity.this, false, getString(com.VitaBit.VitaBit.R.string.main_more_sycn_fail), Toast.LENGTH_SHORT);
                    }
                }
            }
        });
    ...
    private HttpCallback<String> httpCallback = new HttpCallback<String>() {
        ...
        public void onFailed(int what, String url, Object tag, CharSequence message, int responseCode, long networkMillis) {
            ...
            ToolKits.showCommonTosat(BodyActivity.this, false, getString(com.VitaBit.VitaBit.R.string.login_form_error), Toast.LENGTH_SHORT);
        }
    };
    ...
    private boolean checkBodyInfo() {
        ...
        if (CommonUtils.isStringEmpty(String.valueOf(et_userAge.getText()), true)) {
            et_userAge.setError(getString(com.VitaBit.VitaBit.R.string.body_info_age_is_necessary));
            return false;
        } else {
            int age = CommonUtils.getIntValue(et_userAge.getText().toString());
            if (age < 12 || age > 114)
            {
                et_userAge.setError(getString(com.VitaBit.VitaBit.R.string.body_info_age_recommend));
                return false;
            }
        }
        /**
...
//            popupWindow.setText(popupWindow, getString(R.string.body_info_height_is_necessary));
            et_userHeight.setError(getString(com.VitaBit.VitaBit.R.string.body_info_height_is_necessary));
            return false;
        } else {
            int height = CommonUtils.getIntValue(et_userHeight.getText().toString());
...
//                popupWindow.setText(popupWindow, getString(R.string.body_info_height_recommend));
                et_userHeight.setError(getString(com.VitaBit.VitaBit.R.string.body_info_height_recommend));
                return false;
            }
        }
        /**
...
//            popupWindow.setText(popupWindow, getString(R.string.body_info_weight_is_necessary));
            et_userWeight.setError(getString(com.VitaBit.VitaBit.R.string.body_info_weight_is_necessary));
            return false;
        } else {
            int weight = CommonUtils.getIntValue(et_userWeight.getText().toString());
...
//                popupWindow.setText(popupWindow, getString(R.string.body_info_weight_recommend));
                 et_userWeight.setError(getString(com.VitaBit.VitaBit.R.string.body_info_weight_recommend));
                return false;
            }
        }
        return true;
