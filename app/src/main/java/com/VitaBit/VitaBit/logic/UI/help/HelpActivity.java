package com.VitaBit.VitaBit.logic.UI.help;
...
import com.VitaBit.VitaBit.logic.UI.main.datachatactivity.DetailChartControl;
...
public class HelpActivity extends ToolBarActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.VitaBit.VitaBit.R.layout.activity_help);
...
//        SetBarTitleText(getString(R.string.help_activity));
        ...
        detailChartControl = (DetailChartControl)findViewById(com.VitaBit.VitaBit.R.id.activity_sport_data_detail_detailChartView1);
...
//        DaySynopicTable.saveToSqlite(HelpActivity.this, SportDataHelper.creatDaySynopiclist(srsOffline),userEntity.getUser_id());
    ...
    private void BarChartCombined(CombinedChart barChart){
        ...
        // 字体颜色
        mLegend.setTextColor(getResources().getColor(com.VitaBit.VitaBit.R.color.white));
        // 设置背景
        barChart.setBackgroundColor(getResources().getColor(com.VitaBit.VitaBit.R.color.yellow_title));
        ...
        // 显示表格颜色
        barChart.setGridBackgroundColor(getResources().getColor(com.VitaBit.VitaBit.R.color.yellow_title));
    ...
    public BarData generateBarData() {
        ...
        dataSet.setColor(getResources().getColor(com.VitaBit.VitaBit.R.color.white));
        // 柱形图顶端字是否显示
