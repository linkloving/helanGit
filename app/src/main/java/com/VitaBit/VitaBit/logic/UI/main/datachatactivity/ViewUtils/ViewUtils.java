...
public class ViewUtils {
    ...
    public static void initchat(Context context, CombinedChart barChart) {
        ...
        // 字体颜色
        mLegend.setTextColor(context.getResources().getColor(com.VitaBit.VitaBit.R.color.white));
        // 设置背景
        ...
        // 显示表格颜色
        barChart.setGridBackgroundColor(context.getResources().getColor(com.VitaBit.VitaBit.R.color.yellow_title));
...
//        xAxis.setAvoidFirstLastClipping(true);//如果设置为true，则在绘制时会避免“剪掉”在x轴上的图表或屏幕边缘的第一个和最后一个坐标轴标签项。但是会偏移掉
    ...
    public static BarDataSet getDataSet(Context context,List<BarEntry> entries){
        ...
        // 柱形图颜色
        dataSet.setColor(context.getResources().getColor(com.VitaBit.VitaBit.R.color.sleep_blue));
        // 柱形图顶端字是否显示
        dataSet.setDrawValues(false);
        // 柱形图顶端字体颜色
        dataSet.setValueTextColor(context.getResources().getColor(com.VitaBit.VitaBit.R.color.white));
        // 柱形图顶端字体大小
...
//        dataSet.setBarSpacePercent(60);
    ...
    public static int[] getChartColors(Context context){
        int[] colors = new int[]{
                context.getResources().getColor(com.VitaBit.VitaBit.R.color.chart_color_stand),
                context.getResources().getColor(com.VitaBit.VitaBit.R.color.chart_color_sit),
                context.getResources().getColor(com.VitaBit.VitaBit.R.color.chart_color_walk)};
        return colors;
    }
}
