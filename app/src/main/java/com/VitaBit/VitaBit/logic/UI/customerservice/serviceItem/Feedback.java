...
import com.VitaBit.VitaBit.logic.UI.customerservice.FeedbackAdapter;
...
import com.VitaBit.VitaBit.logic.UI.customerservice.itemBean.FeedbackMsgEntity;
import com.VitaBit.VitaBit.logic.UI.customerservice.itemBean.Feedback_Server;
...
public class Feedback extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflateAndSetupView(inflater, container, savedInstanceState, com.VitaBit.VitaBit.R.layout.layout_feedback);
    }

    private View inflateAndSetupView(LayoutInflater inflater, ViewGroup container,
                                     Bundle savedInstanceState, int layoutResourceId) {
        View layout = inflater.inflate(layoutResourceId, container, false);
        view =inflater.inflate (com.VitaBit.VitaBit.R.layout.toast_layout, null);
        ...
        //设置Toast对象所要展示的视图
        toast.setView(view);
        mRecyclerView = (RecyclerView) layout.findViewById(com.VitaBit.VitaBit.R.id.feedback_list_recyclerView);
        comments_edittext = (EditText) layout.findViewById(com.VitaBit.VitaBit.R.id.main_about_comments_edittext);
        comments_sendBtn = (Button) layout.findViewById(com.VitaBit.VitaBit.R.id.main_about_comment_btn);
        mSwipeRefreshLayout = (SwipeRefreshLayout) layout.findViewById(com.VitaBit.VitaBit.R.id.feedback_swipe_refresh_widget);
        ...
        comments_sendBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (CommonUtils.isStringEmpty(content) || content.length() > 200) {
                    comments_edittext.setError(getString(com.VitaBit.VitaBit.R.string.main_about_send_adv_content));
                    return;
                }
                if(MyApplication.getInstance(getContext()).isLocalDeviceNetworkOk()){
                    sendMail(content);
                }else {
                    MyToast.show(getContext(), getString(com.VitaBit.VitaBit.R.string.main_more_sycn_fail), Toast.LENGTH_LONG);
                }
    ...
    private com.VitaBit.VitaBit.http.basic.HttpCallback<String> HttpCallback = new HttpCallback<String>() {
        @Override
