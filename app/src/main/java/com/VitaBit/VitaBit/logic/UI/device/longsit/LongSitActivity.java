package com.VitaBit.VitaBit.logic.UI.device.longsit;
...
import com.VitaBit.VitaBit.logic.UI.device.alarm.PickerView;
...
public class LongSitActivity extends ToolBarActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.VitaBit.VitaBit.R.layout.activity_long_sit);
    ...
    protected void initView() {
        SetBarTitleText(getString((com.VitaBit.VitaBit.R.string.long_sit_text)));
        mLinearLayout = (LinearLayout) findViewById(com.VitaBit.VitaBit.R.id.longsit_time_ll);
        mCheckBox = (CheckBox) findViewById(com.VitaBit.VitaBit.R.id.longsit_switch_checkbox);
        mTextView = (TextView) findViewById(com.VitaBit.VitaBit.R.id.tv_longsit);
        img_longsit = (ImageView) findViewById(com.VitaBit.VitaBit.R.id.img_longsit);
        BLE_Button= (Button) findViewById(com.VitaBit.VitaBit.R.id.longsit_btn_Synchronize_device);
        Synchronize_device= (LinearLayout) findViewById(com.VitaBit.VitaBit.R.id.longsit_Synchronize_device);

        long_sit_start_time_one_linear = (LinearLayout) findViewById(com.VitaBit.VitaBit.R.id.long_sit_start_time_one_linear);
        long_sit_end_time_one_linear = (LinearLayout) findViewById(com.VitaBit.VitaBit.R.id.long_sit_end_time_one_linear);
        long_sit_start_time_two_linear = (LinearLayout) findViewById(com.VitaBit.VitaBit.R.id.long_sit_start_time_two_linear);
        long_sit_end_time_two_linear = (LinearLayout) findViewById(com.VitaBit.VitaBit.R.id.long_sit_end_time_two_linear);

        long_sit_start_time_one = (TextView) findViewById(com.VitaBit.VitaBit.R.id.long_sit_start_time_one);
        long_sit_end_time_one = (TextView) findViewById(com.VitaBit.VitaBit.R.id.long_sit_end_time_one);
        long_sit_start_time_two = (TextView) findViewById(com.VitaBit.VitaBit.R.id.long_sit_start_time_two);
        long_sit_end_time_two = (TextView) findViewById(com.VitaBit.VitaBit.R.id.long_sit_end_time_two);
        long_sit_step_edit = (EditText) findViewById(com.VitaBit.VitaBit.R.id.long_sit_step_edit);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case com.VitaBit.VitaBit.R.id.long_sit_start_time_one_linear:
                ShowPopupWindow(start_time_one_hour, start_time_one_minute, START_TIME);
                break;
            case com.VitaBit.VitaBit.R.id.long_sit_end_time_one_linear:
                ShowPopupWindow(end_time_one_hour, end_time_one_minute, END_TIME);
                break;
            case com.VitaBit.VitaBit.R.id.long_sit_start_time_two_linear:
                ShowPopupWindow(start_time_two_hour, start_time_two_minute, START_TIME1);
                break;
            case com.VitaBit.VitaBit.R.id.long_sit_end_time_two_linear:
                ShowPopupWindow(end_time_two_hour, end_time_two_minute, END_TIME1);
                break;
            case com.VitaBit.VitaBit.R.id.longsit_switch_checkbox:
                if (mCheckBox.isChecked()) {
                    img_longsit.setImageResource(com.VitaBit.VitaBit.R.mipmap.s_inactive_on_144px);
                    mLinearLayout.setVisibility(View.VISIBLE);
                    mTextView.setTextColor(Color.parseColor("#FF7700"));
                    try {
                        setNotificition();
                    ...
                    img_longsit.setImageResource(com.VitaBit.VitaBit.R.mipmap.s_inactive_off_144px);
                    mLinearLayout.setVisibility(View.GONE);
                    mTextView.setTextColor(Color.parseColor("#666666"));
                    try {
                        setNotificition();
    ...
    private void ShowPopupWindow(String Hour, String Minute, int TagTime) {
        View layout = LayoutInflater.from(LongSitActivity.this).inflate(com.VitaBit.VitaBit.R.layout.dialog_layout, null);
        BACK_btn = (Button) layout.findViewById(com.VitaBit.VitaBit.R.id.BACK_btn);
        OK_btn = (Button) layout.findViewById(com.VitaBit.VitaBit.R.id.OK_btn);
        ...
        popupWindow.setAnimationStyle(com.VitaBit.VitaBit.R.style.PopupAnimation);
...
//                判断结束时间是否小于第一个开始时间或第二个结束时间
                ...
                if (
                    ...
                    Toast.makeText(LongSitActivity.this, getString(com.VitaBit.VitaBit.R.string.saved_to_local), Toast.LENGTH_LONG).show();
                    popupWindow.dismiss();
                } else {
                    //弹窗Dialog
                    AlertDialog.Builder dialog = new AlertDialog.Builder(LongSitActivity.this);
                    dialog.setTitle(getString(com.VitaBit.VitaBit.R.string.effective_time_is_invalid));
                    dialog.setMessage(getString(com.VitaBit.VitaBit.R.string.long_sit_time_error_message));
                    dialog.setPositiveButton(getString(com.VitaBit.VitaBit.R.string.queren), null);
                    dialog.show();
                }
        ...
        popupWindow.showAtLocation(LongSitActivity.this.findViewById(com.VitaBit.VitaBit.R.id.longsit_layout), Gravity.BOTTOM, 0, 0);
    }

    private void setTime(View view, String HourTime, String MinuteTime, final int Tagtime) {

        PickerView hour_pv = (PickerView) view.findViewById(com.VitaBit.VitaBit.R.id.hour_pv);
        PickerView minute_pv = (PickerView) view.findViewById(com.VitaBit.VitaBit.R.id.minute_pv);
    ...
    private void setNotificition() throws ParseException {
       ...
       //判断蓝牙是否连接
        if (provider.isConnectedAndDiscovered()) {
            ...
            BLE_Button.setText(getString(com.VitaBit.VitaBit.R.string.saved_to_local));
            toast.show();
        }else{
            android.support.v7.app.AlertDialog dialog = new android.support.v7.app.AlertDialog.Builder(LongSitActivity.this)
                    .setTitle(ToolKits.getStringbyId(LongSitActivity.this, com.VitaBit.VitaBit.R.string.portal_main_unbound))
                    .setMessage(ToolKits.getStringbyId(LongSitActivity.this, com.VitaBit.VitaBit.R.string.portal_main_unbound_msg))
                    .setPositiveButton(ToolKits.getStringbyId(LongSitActivity.this, com.VitaBit.VitaBit.R.string.general_ok),
