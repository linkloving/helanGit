...
public class CircleClipLayout extends FrameLayout
{
    ...
    protected void doInit(Context context, AttributeSet attrs)
    {
        if (null != attrs)
        {
            TypedArray a = context.obtainStyledAttributes(attrs, com.VitaBit.VitaBit.R.styleable.CircleClipLayout);
            m_borderWidth = a.getDimension(com.VitaBit.VitaBit.R.styleable.CircleClipLayout_app_borderWidth, 3);
        }
