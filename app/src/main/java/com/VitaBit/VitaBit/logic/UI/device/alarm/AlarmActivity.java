package com.VitaBit.VitaBit.logic.UI.device.alarm;
...
import com.VitaBit.VitaBit.prefrences.LocalUserSettingsToolkits;
import com.VitaBit.VitaBit.prefrences.devicebean.DeviceSetting;
import com.VitaBit.VitaBit.utils.DeviceInfoHelper;
...
public class AlarmActivity extends ToolBarActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.VitaBit.VitaBit.R.layout.activity_alarm);
    ...
    protected void initView() {
        SetBarTitleText(getString((com.VitaBit.VitaBit.R.string.alarm_notify)));
        mLinearLayout = (LinearLayout) findViewById(com.VitaBit.VitaBit.R.id.linearLayout);
        mLinearLayout1 = (LinearLayout) findViewById(com.VitaBit.VitaBit.R.id.linearLayout1);
        mLinearLayout2 = (LinearLayout) findViewById(com.VitaBit.VitaBit.R.id.linearLayout2);

        mImageView = (ImageView) findViewById(com.VitaBit.VitaBit.R.id.img_switch);
        tv_showtime = (TextView) findViewById(com.VitaBit.VitaBit.R.id.tv_showtime);

        mImageView1 = (ImageView) findViewById(com.VitaBit.VitaBit.R.id.img_switch1);
        tv_showtime1 = (TextView) findViewById(com.VitaBit.VitaBit.R.id.tv_showtime1);

        mImageView2 = (ImageView) findViewById(com.VitaBit.VitaBit.R.id.img_switch2);
        tv_showtime2 = (TextView) findViewById(com.VitaBit.VitaBit.R.id.tv_showtime2);


        view= LayoutInflater.from(this).inflate(com.VitaBit.VitaBit.R.layout.toast_synchronize, null);
    ...
    private void initData() {
        ...
        if (Integer.parseInt(strAlarm_one[2]) == 0) {
            mImageView.setImageResource(com.VitaBit.VitaBit.R.mipmap.btn_off);
            tv_showtime.setTextColor(getResources().getColor(com.VitaBit.VitaBit.R.color.text_gray));
            tv_showtime.setText(strTime);
            tv_color = false;
        } else {
            mImageView.setImageResource(com.VitaBit.VitaBit.R.mipmap.btn_on);
            tv_showtime.setTextColor(getResources().getColor(com.VitaBit.VitaBit.R.color.yellow_title));
            tv_showtime.setText(strTime);
            tv_color = true;
        }
        ...
        if (Integer.parseInt(strAlarm_two[2]) == 0) {
            mImageView1.setImageResource(com.VitaBit.VitaBit.R.mipmap.btn_off);
            tv_showtime1.setTextColor(getResources().getColor(com.VitaBit.VitaBit.R.color.text_gray));
            tv_showtime1.setText(strAlarm_two[0]);
            tv_color1 = false;
        } else {
            mImageView1.setImageResource(com.VitaBit.VitaBit.R.mipmap.btn_on);
            tv_showtime1.setTextColor(getResources().getColor(com.VitaBit.VitaBit.R.color.yellow_title));
            tv_showtime1.setText(strAlarm_two[0]);
            tv_color1 = true;
        }
        ...
        if (Integer.parseInt(strAlarm_three[2]) == 0) {
            mImageView2.setImageResource(com.VitaBit.VitaBit.R.mipmap.btn_off);
            tv_showtime2.setTextColor(getResources().getColor(com.VitaBit.VitaBit.R.color.text_gray));
            tv_showtime2.setText(strAlarm_three[0]);
            tv_color2 = false;
        } else {
            mImageView2.setImageResource(com.VitaBit.VitaBit.R.mipmap.btn_on);
            tv_showtime2.setTextColor(getResources().getColor(com.VitaBit.VitaBit.R.color.yellow_title));
            tv_showtime2.setText(strAlarm_three[0]);
            tv_color2 = true;
        }
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case com.VitaBit.VitaBit.R.id.img_switch:
                if (tv_color == false) {
                ...
                break;
            case com.VitaBit.VitaBit.R.id.linearLayout:
                IntentFactory.start_SetAlarmActivity(AlarmActivity.this, ALARM_ONE, tv_showtime.getText().toString(),strRepeat);
                break;


            case com.VitaBit.VitaBit.R.id.img_switch1:
                if (tv_color1 == false) {
            ...
            case com.VitaBit.VitaBit.R.id.img_switch2:
                ...
                break;
            case com.VitaBit.VitaBit.R.id.linearLayout2:
    ...
    private void Synchronize_device() throws ParseException {
        ...
        if (CommonUtils.isStringEmpty(s)) {
            AlertDialog dialog = new AlertDialog.Builder(AlarmActivity.this)
                    .setTitle(ToolKits.getStringbyId(AlarmActivity.this, com.VitaBit.VitaBit.R.string.portal_main_unbound))
                    .setMessage(ToolKits.getStringbyId(AlarmActivity.this, com.VitaBit.VitaBit.R.string.portal_main_unbound_msg))
                    .setPositiveButton(ToolKits.getStringbyId(AlarmActivity.this, com.VitaBit.VitaBit.R.string.general_ok),
    ...
    private void initCheckBoxStatus(int repeat, int index) {
        if (index == ALARM_ONE) {
            for (int i = 0; i < 7; i++) {
                ...
                if (check.isChecked()) {
                    check.setTextColor(getResources().getColor(com.VitaBit.VitaBit.R.color.yellow_title));
                } else {
                    check.setTextColor(getResources().getColor(com.VitaBit.VitaBit.R.color.text_gray));
                }
            }
    ...
    private int getCheckBoxIdByIndex(int i, int week_index) {
        if (week_index == ALARM_ONE) {
            switch (i) {
                case 0:
                    return com.VitaBit.VitaBit.R.id.alarm_change_alarm_dialog_sunday;
                case 1:
                    return com.VitaBit.VitaBit.R.id.alarm_change_alarm_dialog_monday;
                case 2:
                    return com.VitaBit.VitaBit.R.id.alarm_change_alarm_dialog_tuesday;
                case 3:
                    return com.VitaBit.VitaBit.R.id.alarm_change_alarm_dialog_wednessday;
                case 4:
                    return com.VitaBit.VitaBit.R.id.alarm_change_alarm_dialog_thursday;
                case 5:
                    return com.VitaBit.VitaBit.R.id.alarm_change_alarm_dialog_friday;
                case 6:
                    return com.VitaBit.VitaBit.R.id.alarm_change_alarm_dialog_saturday;
            }
        } else if (week_index == ALARM_TWO) {
            switch (i) {
                case 0:
                    return com.VitaBit.VitaBit.R.id.alarm_change_alarm_dialog_sunday1;
                case 1:
                    return com.VitaBit.VitaBit.R.id.alarm_change_alarm_dialog_monday1;
                case 2:
                    return com.VitaBit.VitaBit.R.id.alarm_change_alarm_dialog_tuesday1;
                case 3:
                    return com.VitaBit.VitaBit.R.id.alarm_change_alarm_dialog_wednessday1;
                case 4:
                    return com.VitaBit.VitaBit.R.id.alarm_change_alarm_dialog_thursday1;
                case 5:
                    return com.VitaBit.VitaBit.R.id.alarm_change_alarm_dialog_friday1;
                case 6:
                    return com.VitaBit.VitaBit.R.id.alarm_change_alarm_dialog_saturday1;
            }
        } else if (week_index == ALARM_THREE) {
            switch (i) {
                case 0:
                    return com.VitaBit.VitaBit.R.id.alarm_change_alarm_dialog_sunday2;
                case 1:
                    return com.VitaBit.VitaBit.R.id.alarm_change_alarm_dialog_monday2;
                case 2:
                    return com.VitaBit.VitaBit.R.id.alarm_change_alarm_dialog_tuesday2;
                case 3:
                    return com.VitaBit.VitaBit.R.id.alarm_change_alarm_dialog_wednessday2;
                case 4:
                    return com.VitaBit.VitaBit.R.id.alarm_change_alarm_dialog_thursday2;
                case 5:
                    return com.VitaBit.VitaBit.R.id.alarm_change_alarm_dialog_friday2;
                case 6:
                    return com.VitaBit.VitaBit.R.id.alarm_change_alarm_dialog_saturday2;
            }
        }
