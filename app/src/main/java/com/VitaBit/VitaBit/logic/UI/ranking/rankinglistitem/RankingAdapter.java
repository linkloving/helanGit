package com.VitaBit.VitaBit.logic.UI.ranking.rankinglistitem;
...
//                .showImageOnFail(R.mipmap.default_avatar)//加载失败显示图片
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_ITEM) {
            view = LayoutInflater.from(parent.getContext()).inflate(com.VitaBit.VitaBit.R.layout.list_item_rank, null);
            return new RankingViewHolder(view);
        } else if (viewType == TYPE_HEAD) {
            View view = LayoutInflater.from(parent.getContext()).inflate(com.VitaBit.VitaBit.R.layout.list_item_rank_head, parent, false);
            HeadViewHolder headViewHolder = new HeadViewHolder(view);
            return headViewHolder;
        } else if (viewType == TYPE_FOOTER) {
            View foot_view = LayoutInflater.from(parent.getContext()).inflate(com.VitaBit.VitaBit.R.layout.recycler_load_more_layout, parent, false);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof HeadViewHolder) {
            ...
            if (myRankVO.getDistance().equals("0")) {
                headViewHolder.ranking_activity_listview_item_distance_head.setText(mContext.getString(com.VitaBit.VitaBit.R.string.general_null_data));
                ...
                String rank = MessageFormat.format(mContext.getString(com.VitaBit.VitaBit.R.string.ranking_rank), myRankVO.getRank());
            ...
            imageLoader.displayImage(url, headViewHolder.ranking_activity_listview_item_imageView_head, options, new ImageLoadingListener() {
                ...
                public void onLoadingFailed(String imageUri, View view, FailReason failReason) {
                    ...
                    if(U.getUserBase().getUser_sex()==0){
                        //女生
                        headViewHolder.ranking_activity_listview_item_imageView_head.setImageResource(com.VitaBit.VitaBit.R.mipmap.default_avatar_f);
                    }else {
                        //男生
                        headViewHolder.ranking_activity_listview_item_imageView_head.setImageResource(com.VitaBit.VitaBit.R.mipmap.default_avatar_m);
                    }
                }
...
//            if(CommonUtils.isStringEmpty(rankingVO.getRank()))
            if (rankingVO.getRank().equals("1")) {
                ...
                rholder.ranking_activity_listview_item_rank.setBackgroundResource(com.VitaBit.VitaBit.R.mipmap.ranking_1);
                rholder.setIsRecyclable(false);
            } else if (rankingVO.getRank().equals("2")) {
                rholder.ranking_activity_listview_item_rank.setText("");
                rholder.ranking_activity_listview_item_rank.setBackgroundResource(com.VitaBit.VitaBit.R.mipmap.ranking_2);
                rholder.setIsRecyclable(false);
            } else if (rankingVO.getRank().equals("3")) {
                rholder.ranking_activity_listview_item_rank.setText("");
                rholder.ranking_activity_listview_item_rank.setBackgroundResource(com.VitaBit.VitaBit.R.mipmap.ranking_3);
                rholder.setIsRecyclable(false);
            } else {
...
//            final int yizan = Integer.parseInt(rankingVO.getYizan());
            ...
            rholder.ranking_list_item_dingValue.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (integerlist.contains(pos)) {
                        ...
                        CallServer.getRequestInstance().add(mContext, mContext.getString(com.VitaBit.VitaBit.R.string.general_submitting), CommParams.HTTP_RANK, NoHttpRuquestFactory.submit_Rangking_cancle_zan_Request(userTime, "0", rankingVO.getUser_id(), user_id), new HttpCallback<String>() {
                            @Override
                        ...
                        CallServer.getRequestInstance().add(mContext, mContext.getString(com.VitaBit.VitaBit.R.string.general_submitting), CommParams.HTTP_RANK, NoHttpRuquestFactory.submit_Rangking_ding_Request(userTime, "0", rankingVO.getUser_id(), user_id), new HttpCallback<String>() {
                            @Override
                            public void onSucceed(int what, Response<String> response) {
                                DataFromServer dataFromClientNew = JSON.parseObject(response.get(), DataFromServer.class);
                    ...
                    public void onLoadingFailed(String imageUri, View view, FailReason failReason) {
                        if (rholder.ranking_user_head.getTag().equals(imageUri)) {
                            ...
                            if(Integer.parseInt(rankingVOs.get(position - 1).getUser_sex())==0){
                                rholder.ranking_user_head.setImageResource(com.VitaBit.VitaBit.R.mipmap.default_avatar_f);
                            }else {
                                rholder.ranking_user_head.setImageResource(com.VitaBit.VitaBit.R.mipmap.default_avatar_m);
                            }
                        }
                    }
                    @Override
    ...
    private class RankingViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public RankingViewHolder(View itemView) {
            super(itemView);
            mLinearLayout = (LinearLayout) itemView.findViewById(com.VitaBit.VitaBit.R.id.rank_list_layout);
            ranking_activity_listview_item_rank = (TextView) itemView.findViewById(com.VitaBit.VitaBit.R.id.ranking_activity_listview_item_rank);
            //昵称
            ranking_activity_listview_item_nickname = (TextView) itemView.findViewById(com.VitaBit.VitaBit.R.id.ranking_activity_listview_item_nickname);
            //企业
            ranking_list_item_come_from = (TextView) itemView.findViewById(com.VitaBit.VitaBit.R.id.ranking_list_item_come_from);
//步数
            ranking_activity_listview_item_distance = (TextView) itemView.findViewById(com.VitaBit.VitaBit.R.id.ranking_activity_listview_item_distance);
//踩
            ranking_list_item_dingValue = (CheckBox) itemView.findViewById(com.VitaBit.VitaBit.R.id.ranking_list_item_dingValue);


            ranking_user_head = (ImageView) itemView.findViewById(com.VitaBit.VitaBit.R.id.ranking_activity_listview_item_imageView);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
//跳转页面
                case com.VitaBit.VitaBit.R.id.rank_list_layout:
                    //跳转页面
                    break;
    ...
    public class FootViewHolder extends RecyclerView.ViewHolder {
        ...
        public FootViewHolder(View view) {
            super(view);
            foot_view_item = (LinearLayout) view.findViewById(com.VitaBit.VitaBit.R.id.my_foot_linearlayout);
        }
    }
    public class HeadViewHolder extends RecyclerView.ViewHolder {
        ...
        public HeadViewHolder(View itemView) {
            super(itemView);
            mLinearLayout = (LinearLayout) itemView.findViewById(com.VitaBit.VitaBit.R.id.rank_list_layout_head);
            ranking_activity_listview_item_imageView_head = (ImageView) itemView.findViewById(com.VitaBit.VitaBit.R.id.ranking_activity_listview_item_imageView_head);
            ranking_activity_listview_item_nickname_head = (TextView) itemView.findViewById(com.VitaBit.VitaBit.R.id.ranking_activity_listview_item_nickname_head);
            ranking_activity_listview_item_distance_head = (TextView) itemView.findViewById(com.VitaBit.VitaBit.R.id.ranking_activity_listview_item_distance_head);
            tv_steps = (TextView) itemView.findViewById(com.VitaBit.VitaBit.R.id.tv_steps);
            ranking_list_item_myRank_head = (TextView) itemView.findViewById(com.VitaBit.VitaBit.R.id.ranking_list_item_myRank_head);
            ranking_list_item_dingValue_head = (CheckBox) itemView.findViewById(com.VitaBit.VitaBit.R.id.ranking_list_item_dingValue_head);
        }
    }
    //添加数据
