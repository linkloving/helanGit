package com.VitaBit.VitaBit.logic.UI.goal;
...
public class SportGoalActivity extends ToolBarActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.VitaBit.VitaBit.R.layout.activity_spor_goal_setting);
    }
    ...
    protected void initView() {
        SetBarTitleText(getString((com.VitaBit.VitaBit.R.string.goal_title)));

        sport_stored_value_linearlayout= (LinearLayout) findViewById(com.VitaBit.VitaBit.R.id.layout_stored_value);
        target_step_linearlayout= (LinearLayout) findViewById(com.VitaBit.VitaBit.R.id.layout_target_step);
        sport_mileage_linearlayout= (LinearLayout) findViewById(com.VitaBit.VitaBit.R.id.layout_mileage);
        sport_calories_linearlayout= (LinearLayout) findViewById(com.VitaBit.VitaBit.R.id.layout_calories);
        sport_exercise_linearlayout= (LinearLayout) findViewById(com.VitaBit.VitaBit.R.id.layout_exercise);
        sport_exercise_linearlayout.setVisibility(View.GONE);
        sport_sleeping_linearlayout= (LinearLayout) findViewById(com.VitaBit.VitaBit.R.id.layout_sleeping);
        sport_weight_linearlayout= (LinearLayout) findViewById(com.VitaBit.VitaBit.R.id.layout_weight);
        target_step = (TextView) findViewById(com.VitaBit.VitaBit.R.id.sport_target_step);
        ...
        sport_stored_value = (TextView) findViewById(com.VitaBit.VitaBit.R.id.sport_stored_value);
        sport_stored_value.setText(PreferencesToolkits.getGoalInfo(this,PreferencesToolkits.KEY_GOAL_MONEY)+"");

        sport_mileage = (TextView) findViewById(com.VitaBit.VitaBit.R.id.sport_mileage);
        sport_mileage.setText(PreferencesToolkits.getGoalInfo(this,PreferencesToolkits.KEY_GOAL_DISTANCE)+"");

        sport_calories = (TextView) findViewById(com.VitaBit.VitaBit.R.id.sport_calories);
        sport_calories.setText(PreferencesToolkits.getGoalInfo(this,PreferencesToolkits.KEY_GOAL_CAL)+"");

        sport_exercise = (TextView) findViewById(com.VitaBit.VitaBit.R.id.sport_exercise);
        sport_exercise.setText(PreferencesToolkits.getGoalInfo(this,PreferencesToolkits.KEY_GOAL_RUN)+"");

        sport_sleeping = (TextView) findViewById(com.VitaBit.VitaBit.R.id.sport_sleeping);
        sport_sleeping.setText(PreferencesToolkits.getGoalInfo(this, PreferencesToolkits.KEY_GOAL_SLEEP) + "");

        sport_weight = (TextView) findViewById(com.VitaBit.VitaBit.R.id.sport_weight);
        sport_weight.setText(PreferencesToolkits.getGoalInfo(this, PreferencesToolkits.KEY_GOAL_WEIGHT) + "");

        tv_kg = (TextView) findViewById(com.VitaBit.VitaBit.R.id.tv_kg);
        tv_meter = (TextView) findViewById(com.VitaBit.VitaBit.R.id.tv_meter);
        if (SwitchUnit.getLocalUnit(SportGoalActivity.this) == ToolKits.UNIT_GONG) {
            tv_kg.setText(getString(com.VitaBit.VitaBit.R.string.unit_kilogramme));
            tv_meter.setText(getString(com.VitaBit.VitaBit.R.string.unit_m));
        } else {
...
//                sport_mileage.setText(UnitTookits.MChangetoMIRate(Integer.parseInt(sport_mileage.getText().toString())) + "");
            tv_meter.setText(getString(com.VitaBit.VitaBit.R.string.unit_mile));
...
//                sport_weight.setText(UnitTookits.KGChange2LBRate(Integer.parseInt(sport_weight.getText().toString())) + "");
            tv_kg.setText(getString(com.VitaBit.VitaBit.R.string.unit_pound));
...
*/
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case com.VitaBit.VitaBit.R.id.layout_stored_value:
               ...
               /* final Dialog alertDialog1=new Dialog(SportGoalActivity.this);
                ...
                View storelayout = LayoutInflater.from(SportGoalActivity.this).inflate(com.VitaBit.VitaBit.R.layout.dialog_layout_sport, null);
                final EditText storeEdittext;
                storeEdittext = (EditText) storelayout.findViewById(com.VitaBit.VitaBit.R.id.show_msg_sport_goal);
                storeEdittext.setInputType(InputType.TYPE_CLASS_NUMBER);
                AlertDialog dialog1 = new AlertDialog.Builder(SportGoalActivity.this)
                        .setTitle(ToolKits.getStringbyId(SportGoalActivity.this, com.VitaBit.VitaBit.R.string.stored_value))
                        .setView(storelayout)
                        .setPositiveButton(ToolKits.getStringbyId(SportGoalActivity.this, com.VitaBit.VitaBit.R.string.general_yes),
                                new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                        if (CommonUtils.isStringEmpty(storeEdittext.getText().toString().trim())) {
                                            storeEdittext.setError(getString(com.VitaBit.VitaBit.R.string.error_field_required));
                        ...
                        .setNegativeButton(ToolKits.getStringbyId(SportGoalActivity.this, com.VitaBit.VitaBit.R.string.general_no), new DatePickerDialog.OnClickListener(){
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
            ...
            case com.VitaBit.VitaBit.R.id.layout_target_step:
                //弹窗
               /* final Dialog alertDialog2=new Dialog(SportGoalActivity.this);
                ...
                View steplayout =LayoutInflater.from(SportGoalActivity.this).inflate(com.VitaBit.VitaBit.R.layout.dialog_layout_sport, null);
                final EditText stepEdittext;
                stepEdittext = (EditText) steplayout.findViewById(com.VitaBit.VitaBit.R.id.show_msg_sport_goal);
                stepEdittext.setInputType(InputType.TYPE_CLASS_NUMBER);
                AlertDialog dialog = new AlertDialog.Builder(SportGoalActivity.this)
                        .setTitle(ToolKits.getStringbyId(SportGoalActivity.this, com.VitaBit.VitaBit.R.string.report_steps))
                        .setView(steplayout)
                        .setPositiveButton(ToolKits.getStringbyId(SportGoalActivity.this, com.VitaBit.VitaBit.R.string.general_yes),
                                new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                        if (CommonUtils.isStringEmpty(stepEdittext.getText().toString().trim())) {
                                            stepEdittext.setError(getString(com.VitaBit.VitaBit.R.string.error_field_required));
                ...
                break;
            case com.VitaBit.VitaBit.R.id.layout_mileage:
               /* final Dialog alertDialog3=new Dialog(SportGoalActivity.this);
                ...
                final EditText mileageEdittext;
                mileageEdittext = (EditText) mileagelayout.findViewById(com.VitaBit.VitaBit.R.id.show_msg_sport_goal);
                mileageEdittext.setInputType(InputType.TYPE_CLASS_NUMBER);
                AlertDialog dialog2 = new AlertDialog.Builder(SportGoalActivity.this)
                        .setTitle(ToolKits.getStringbyId(SportGoalActivity.this, com.VitaBit.VitaBit.R.string.unit_mileage))
                        ...
                        .setPositiveButton(ToolKits.getStringbyId(SportGoalActivity.this, com.VitaBit.VitaBit.R.string.general_yes),
                                new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        if (CommonUtils.isStringEmpty(mileageEdittext.getText().toString().trim())) {
                                            mileageEdittext.setError(getString(com.VitaBit.VitaBit.R.string.error_field_required));
                ...
                dialog2.show();
                break;
            case com.VitaBit.VitaBit.R.id.layout_calories:
               /* final Dialog alertDialog4=new Dialog(SportGoalActivity.this);
                ...
                View calorieslayout = LayoutInflater.from(SportGoalActivity.this).inflate(
                        com.VitaBit.VitaBit.R.layout.dialog_layout_sport, null);
                final EditText caloriesEdittext;
                caloriesEdittext = (EditText) calorieslayout.findViewById(com.VitaBit.VitaBit.R.id.show_msg_sport_goal);
                caloriesEdittext.setInputType(InputType.TYPE_CLASS_NUMBER);
                AlertDialog dialog3 = new AlertDialog.Builder(SportGoalActivity.this)
                        .setTitle(ToolKits.getStringbyId(SportGoalActivity.this, com.VitaBit.VitaBit.R.string.report_calories))
                        ...
                        .setPositiveButton(ToolKits.getStringbyId(SportGoalActivity.this, com.VitaBit.VitaBit.R.string.general_yes),
                                new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        if (CommonUtils.isStringEmpty(caloriesEdittext.getText().toString().trim())) {
                                            caloriesEdittext.setError(getString(com.VitaBit.VitaBit.R.string.error_field_required));
                ...
                dialog3.show();
                break;
            case com.VitaBit.VitaBit.R.id.layout_exercise:
             ...
             /*   final Dialog alertDialog5=new Dialog(SportGoalActivity.this);
                ...
                View exerciselayout = LayoutInflater.from(SportGoalActivity.this).inflate(
                        com.VitaBit.VitaBit.R.layout.dialog_layout_sport, null);
                final EditText exerciseEdittext;
                exerciseEdittext = (EditText) exerciselayout.findViewById(com.VitaBit.VitaBit.R.id.show_msg_sport_goal);
                exerciseEdittext.setInputType(InputType.TYPE_CLASS_NUMBER);
                AlertDialog dialog4 = new AlertDialog.Builder(SportGoalActivity.this)
                        .setTitle(ToolKits.getStringbyId(SportGoalActivity.this, com.VitaBit.VitaBit.R.string.sport_exercise))
                        ...
                        .setPositiveButton(ToolKits.getStringbyId(SportGoalActivity.this, com.VitaBit.VitaBit.R.string.general_yes),
                                new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        if (CommonUtils.isStringEmpty(exerciseEdittext.getText().toString().trim())) {
                                            exerciseEdittext.setError(getString(com.VitaBit.VitaBit.R.string.error_field_required));
                ...
                dialog4.show();
                break;
            case com.VitaBit.VitaBit.R.id.layout_sleeping:
              ...
              /*
               ...
               View sleepinglayout = LayoutInflater.from(SportGoalActivity.this).inflate(
                        com.VitaBit.VitaBit.R.layout.dialog_layout_sport, null);
                final EditText sleepingEdittext;
                sleepingEdittext = (EditText) sleepinglayout.findViewById(com.VitaBit.VitaBit.R.id.show_msg_sport_goal);
                AlertDialog dialog5 = new AlertDialog.Builder(SportGoalActivity.this)
                        .setTitle(ToolKits.getStringbyId(SportGoalActivity.this, com.VitaBit.VitaBit.R.string.report_sleep))
                        ...
                        .setPositiveButton(ToolKits.getStringbyId(SportGoalActivity.this, com.VitaBit.VitaBit.R.string.general_yes),
                                new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        if (CommonUtils.isStringEmpty(sleepingEdittext.getText().toString().trim())) {
                                            sleepingEdittext.setError(getString(com.VitaBit.VitaBit.R.string.error_field_required));
                ...
                dialog5.show();
                break;
            case com.VitaBit.VitaBit.R.id.layout_weight:
/*
...
*/
                ...
                AlertDialog dialog6 = new AlertDialog.Builder(SportGoalActivity.this)
                        .setTitle(ToolKits.getStringbyId(SportGoalActivity.this, com.VitaBit.VitaBit.R.string.body_info_weight))
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        if (CommonUtils.isStringEmpty(weightEdittext.getText().toString().trim())) {
                                            ...
                                            if (SwitchUnit.getLocalUnit(SportGoalActivity.this) == ToolKits.UNIT_GONG) {
                                                ...
                                                sport_weight.setText(weightEdittext.getText().toString());
                                                tv_kg.setText(getResources().getString(com.VitaBit.VitaBit.R.string.unit_pound));
                                                PreferencesToolkits.setGoalInfo(SportGoalActivity.this, PreferencesToolkits.KEY_GOAL_WEIGHT, weightEdittext.getText().toString());
                                            }
                                            CountCalUtil.allowCloseDialog(dialog, true);//对话框消失
                                        }
