...
import com.VitaBit.VitaBit.logic.UI.personal.AttentionUserInfoDTO;
...
public class CommentAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == IMVT_QUESTION_MSG) {
            view = LayoutInflater.from(parent.getContext()).inflate(com.VitaBit.VitaBit.R.layout.comment_item_right, null);
            return new FeedbackHolder(view);
        } else if (viewType == IMVT_ANSWER_MSG) {
            view = LayoutInflater.from(parent.getContext()).inflate(com.VitaBit.VitaBit.R.layout.comment_item_left, null);
...
//显示用户数据
            ...
            options = new DisplayImageOptions.Builder()
                    ...
                    .showImageOnFail(com.VitaBit.VitaBit.R.mipmap.default_avatar)//加载失败显示图片
            ...
            if(MyApplication.getInstance(mContext).isLocalDeviceNetworkOk()) {
                ...
                Toast.makeText(mContext, mContext.getString(com.VitaBit.VitaBit.R.string.smssdk_network_error), Toast.LENGTH_LONG).show();
...
//                url_avatr[0] = NoHttpRuquestFactory.getUserAvatarDownloadURL(mContext, entity.getTo_user_id()+"", "", true);
    ...
    private class FeedbackHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public FeedbackHolder(View itemView) {
            super(itemView);
            feedback_Avatar = (ImageView) itemView.findViewById(com.VitaBit.VitaBit.R.id.iv_userhead_comment_list);
            feedback_Time = (TextView) itemView.findViewById(com.VitaBit.VitaBit.R.id.tv_sendtime_comment_list);
            feedback_UserName = (TextView) itemView.findViewById(com.VitaBit.VitaBit.R.id.tv_username_comment_list);
            feedback_Content = (TextView) itemView.findViewById(com.VitaBit.VitaBit.R.id.tv_chatcontent_comment_list);
    ...
    private class FeedbackReplyHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public FeedbackReplyHolder(View itemView) {
            super(itemView);
            feedback_Avatar = (ImageView) itemView.findViewById(com.VitaBit.VitaBit.R.id.iv_userhead_left_list);
            feedback_Time = (TextView) itemView.findViewById(com.VitaBit.VitaBit.R.id.tv_sendtime_comment_list);
            feedback_UserName = (TextView) itemView.findViewById(com.VitaBit.VitaBit.R.id.tv_username_comment_list);
            feedback_Content = (TextView) itemView.findViewById(com.VitaBit.VitaBit.R.id.tv_chatcontent_comment_list);
        }
