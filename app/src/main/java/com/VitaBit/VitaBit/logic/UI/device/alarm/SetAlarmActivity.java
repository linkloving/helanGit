...
//    int  Minute;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.VitaBit.VitaBit.R.layout.activity_set_alarm);
        initData();
    ...
    protected void initView() {
        ...
        btn_savetime = (Button) findViewById(com.VitaBit.VitaBit.R.id.btn_savetime);
        hour_pv = (PickerView) findViewById(com.VitaBit.VitaBit.R.id.hour_pv);
        minute_pv = (PickerView) findViewById(com.VitaBit.VitaBit.R.id.minute_pv);

        monday = (CheckBox) findViewById(com.VitaBit.VitaBit.R.id.set_alarm_change_alarm_dialog_monday);
        tuesday = (CheckBox) findViewById(com.VitaBit.VitaBit.R.id.set_alarm_change_alarm_dialog_tuesday);
        wednessday = (CheckBox) findViewById(com.VitaBit.VitaBit.R.id.set_alarm_change_alarm_dialog_wednessday);
        thursday = (CheckBox) findViewById(com.VitaBit.VitaBit.R.id.set_alarm_change_alarm_dialog_thursday);
        friday = (CheckBox) findViewById(com.VitaBit.VitaBit.R.id.set_alarm_change_alarm_dialog_friday);
        saturday = (CheckBox) findViewById(com.VitaBit.VitaBit.R.id.set_alarm_change_alarm_dialog_saturday);
        sunday = (CheckBox) findViewById(com.VitaBit.VitaBit.R.id.set_alarm_change_alarm_dialog_sunday);
...
//        }
    ...
    public void onClick(View v) {
        switch(v.getId()){
            case com.VitaBit.VitaBit.R.id.btn_savetime:
                int repeat=setRepeat();
                if(repeat==0){
                    MyToast.show(this,getString(com.VitaBit.VitaBit.R.string.choose_date), Toast.LENGTH_LONG);
                }else {
                    /***保存闹钟时间和重复周期***/
    ...
    private int getCheckBoxIdByIndex(int i) {
        switch (i) {
            case 0:
                return com.VitaBit.VitaBit.R.id.set_alarm_change_alarm_dialog_sunday;
            case 1:
                return com.VitaBit.VitaBit.R.id.set_alarm_change_alarm_dialog_monday;
            case 2:
                return com.VitaBit.VitaBit.R.id.set_alarm_change_alarm_dialog_tuesday;
            case 3:
                return com.VitaBit.VitaBit.R.id.set_alarm_change_alarm_dialog_wednessday;
            case 4:
                return com.VitaBit.VitaBit.R.id.set_alarm_change_alarm_dialog_thursday;
            case 5:
                return com.VitaBit.VitaBit.R.id.set_alarm_change_alarm_dialog_friday;
            case 6:
                return com.VitaBit.VitaBit.R.id.set_alarm_change_alarm_dialog_saturday;
        }
        return 0;
    }
    @Override
