...
public class PassWordActivity extends Activity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.VitaBit.VitaBit.R.layout.activity_pass_word);
    ...
    private void initView(){
        ...
        passWord = (EditText) findViewById(com.VitaBit.VitaBit.R.id.password_phone_register);
        confirpassWord = (EditText) findViewById(com.VitaBit.VitaBit.R.id.password_phone_register1);
        next= (Button) findViewById(com.VitaBit.VitaBit.R.id.login_form_phone_register);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(MyApplication.getInstance(PassWordActivity.this).isLocalDeviceNetworkOk()){
                        ...
                        MyToast.show(PassWordActivity.this, getString(com.VitaBit.VitaBit.R.string.main_more_sycn_fail), Toast.LENGTH_LONG);
    ...
    private void submittoserver() {
         ...
         try {
            ...
            com.VitaBit.VitaBit.logic.UI.launch.dto.UserRegisterDTO userRegisterDTO = new com.VitaBit.VitaBit.logic.UI.launch.dto.UserRegisterDTO();
