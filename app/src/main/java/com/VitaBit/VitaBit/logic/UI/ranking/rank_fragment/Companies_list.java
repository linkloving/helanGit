package com.VitaBit.VitaBit.logic.UI.ranking.rank_fragment;
...
import com.VitaBit.VitaBit.logic.UI.ranking.rankinglistitem.CompaniesMyRankVO;
import com.VitaBit.VitaBit.logic.UI.ranking.rankinglistitem.RankListDTO;
...
import com.VitaBit.VitaBit.logic.UI.ranking.rankinglistitem.RankingVO;
...
boolean last=true;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflateAndSetupView(inflater, container, savedInstanceState, com.VitaBit.VitaBit.R.layout.rank_fragment_companies_list);
    }

    private View inflateAndSetupView(LayoutInflater inflater, ViewGroup container,
                                     Bundle savedInstanceState, int layoutResourceId) {
        View layout = inflater.inflate(layoutResourceId, container, false);
        mRecyclerView = (RecyclerView) layout.findViewById(com.VitaBit.VitaBit.R.id.companies_list_recyclerView);
        ranking_activity_dateView = (TextView) layout.findViewById(com.VitaBit.VitaBit.R.id.ranking_activity_companies_dateView);
        ranking_activity_leftBtn = (Button) layout.findViewById(com.VitaBit.VitaBit.R.id.ranking_activity_companies_leftBtn);
...
//                点击按钮 时间往后一天  刷新界面
        ...
        ranking_activity_rightBtn = (Button) layout.findViewById(com.VitaBit.VitaBit.R.id.ranking_activity_companies_rightBtn);
        ...
        mSwipeRefreshLayout = (SwipeRefreshLayout) layout.findViewById(com.VitaBit.VitaBit.R.id.rank_swipe_refresh_companies_widget);
...
//            CallServer.getRequestInstance().add(getContext(), getString(R.string.general_submitting), CommParams.HTTP_RANK, NoHttpRuquestFactory.create_Ranking_Count_Basic_Info(rankListDTO), httpCallback);
            ...
            MyToast.show(getContext(), getString(com.VitaBit.VitaBit.R.string.general_network_faild), Toast.LENGTH_LONG);
        }
...
//            }
        ...
        MyLog.e(TAG,"企业排行请求失败！");
            mSwipeRefreshLayout.setRefreshing(false);
            MyToast.show(getActivity(), getString(com.VitaBit.VitaBit.R.string.login_form_error), Toast.LENGTH_SHORT);
        }
    };
...
//            mSwipeRefreshLayout.setRefreshing(false);
            ...
            rankListDTO.setStart_datetime_utc(TimeZoneHelper.__getUTC0FromLocalTime(ToolKits.DATE_FORMAT_YYYY_MM_DD_HH_MM_SS, star_datetime_utc + " 00:00:00"));
            rankListDTO.setPage(pageIndex);
            CallServer.getRequestInstance().add(getContext(), getString(com.VitaBit.VitaBit.R.string.general_submitting), CommParams.HTTP_RANK, NoHttpRuquestFactory.create_Ranking_Count_Basic_Info(rankListDTO), httpCallback);
        }
