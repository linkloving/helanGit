...
public class LoginPageActivity extends AutoLayoutActivity implements View.OnClickListener, Handler.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.VitaBit.VitaBit.R.layout.activity_login_page);
    ...
    private void initView() {
        Login_btn = (Button) this.findViewById(com.VitaBit.VitaBit.R.id.login_btn);
        Registered_btn = (Button) this.findViewById(com.VitaBit.VitaBit.R.id.registered_btn);
        Login_QQ_btn = (ImageView) findViewById(com.VitaBit.VitaBit.R.id.btn_login_qq);
        login_WeChat = (ImageView) findViewById(com.VitaBit.VitaBit.R.id.btn_login_weixin);
        Login_Facebook_btn = (ImageView) findViewById(com.VitaBit.VitaBit.R.id.btn_login_facebook);
        login_Twitter = (ImageView) findViewById(com.VitaBit.VitaBit.R.id.btn_login_twitter);
        login_Google = (ImageView) findViewById(com.VitaBit.VitaBit.R.id.btn_login_google);
...
//      login_ViewPager= (ViewPager) findViewById(R.id.login_ViewPager);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case com.VitaBit.VitaBit.R.id.login_btn:
                IntentFactory.start_LoginPage_Activity(LoginPageActivity.this);
                break;
            case com.VitaBit.VitaBit.R.id.registered_btn:
        ...
        google.setPlatformActionListener(new PlatformActionListener() {
            ...
            public void onComplete(Platform platform, int i, HashMap<String, Object> hashMap) {
                ...
                if (MyApplication.getInstance(LoginPageActivity.this).isLocalDeviceNetworkOk()) {
                    ...
                    MyToast.show(LoginPageActivity.this, getString(com.VitaBit.VitaBit.R.string.general_network_faild), Toast.LENGTH_LONG);
            }
...
//                Toast.makeText(LoginPageActivity.this, getString(R.string.login_activity_wechat_success), Toast.LENGTH_SHORT).show();
            ...
            case WX_ERROR: {
                ...
                // 失败
                Toast.makeText(LoginPageActivity.this, getString(com.VitaBit.VitaBit.R.string.login_activity_wechat_fail), Toast.LENGTH_SHORT).show();
                String expName = msg.obj.getClass().getSimpleName();
                MyLog.i(TAG, ">>>>>微信>>>>>" + expName);
                if ("WechatClientNotExistException".equals(expName)
                        || "WechatTimelineNotSupportedException".equals(expName)
                        || "WechatFavoriteNotSupportedException".equals(expName)) {
                    Toast.makeText(LoginPageActivity.this, getString(com.VitaBit.VitaBit.R.string.login_activity_wechat), Toast.LENGTH_SHORT).show();
                }
                break;
            }
            case WX_CALCEL: {
                ...
                MyLog.i(TAG, "取消····");
                System.out.print(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");
                Toast.makeText(LoginPageActivity.this, getString(com.VitaBit.VitaBit.R.string.login_activity_wechat_cancle), Toast.LENGTH_SHORT)
                        .show();
                if (dialog != null) {
                    if (dialog.isShowing()) {
                        dialog.dismiss();
...
//                Toast.makeText(LoginPageActivity.this, getString(R.string.login_activity_wechat_success), Toast.LENGTH_SHORT).show();
   ...
   if (MyApplication.getInstance(LoginPageActivity.this).isLocalDeviceNetworkOk()) {
            ...
            CallServer.getRequestInstance().add(LoginPageActivity.this, getString(com.VitaBit.VitaBit.R.string.login_form_logining), CommParams.HTTP_LOGIN_WECHAT, NoHttpRuquestFactory.create_Login_Other_Request(userBase), httpCallback);
       } else
      MyToast.show(LoginPageActivity.this, getString(com.VitaBit.VitaBit.R.string.general_network_faild), Toast.LENGTH_LONG);
    }
...
//                        MyToast.show(LoginPageActivity.this, "id=" + userAuthedInfo.getUser_id(), Toast.LENGTH_LONG);
                        ...
                        MyToast.showShort(LoginPageActivity.this, getString(com.VitaBit.VitaBit.R.string.login_error4));
                    }
                    break;
    ...
    private void requestPermissions() {
        // Provide an additional rationale to the user. This would happen if the user denied the
            AlertDialog dialog = new AlertDialog.Builder(this)
                    .setTitle(ToolKits.getStringbyId(this, com.VitaBit.VitaBit.R.string.general_tip))
                    .setMessage(ToolKits.getStringbyId(this, com.VitaBit.VitaBit.R.string.permission_ble))
                    .setPositiveButton(ToolKits.getStringbyId(this, com.VitaBit.VitaBit.R.string.general_ok),
