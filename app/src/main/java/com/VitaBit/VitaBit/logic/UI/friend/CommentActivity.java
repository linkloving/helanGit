...
import com.VitaBit.VitaBit.db.comment.Comment_Util;
...
import com.VitaBit.VitaBit.logic.UI.friend.chatbean.UserChatDTO;
...
import com.VitaBit.VitaBit.logic.UI.friend.chatbean.CommentChat;
import com.VitaBit.VitaBit.logic.UI.friend.chatbean.UserChat;
import com.VitaBit.VitaBit.logic.UI.friend.fragment.CommentAdapter;
...
public class CommentActivity extends ToolBarActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.VitaBit.VitaBit.R.layout.activity_common);
        if (comein_comment == 1)
...
//        to_user_id = intentTemp.getExtras().getInt("__to_user_id__");
    ...
    protected void initView() {
        SetBarTitleText(getString(com.VitaBit.VitaBit.R.string.whats_up_detail_sendMsg));
        sendMessage = (Button) findViewById(com.VitaBit.VitaBit.R.id.comment_about_comment_btn);
        content = (TextView) findViewById(com.VitaBit.VitaBit.R.id.comment_about_comments_edittext);
        mRecyclerView = (RecyclerView) findViewById(com.VitaBit.VitaBit.R.id.comment_list_recyclerView);
        mSwipeRefreshLayout = (SwipeRefreshLayout) findViewById(com.VitaBit.VitaBit.R.id.comment_swipe_refresh_widget);
        mSwipeRefreshLayout.setProgressBackgroundColorSchemeColor(getResources().getColor(com.VitaBit.VitaBit.R.color.white));
        ...
        sendMessage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (comment_content.isEmpty()) {
                    MyToast.show(CommentActivity.this, getString(com.VitaBit.VitaBit.R.string.relationship_comment_empty), Toast.LENGTH_LONG);
                    return;
                }
...
//            if(comein_comment==1) {
            ...
            CallServer.getRequestInstance().add(CommentActivity.this, getString(com.VitaBit.VitaBit.R.string.general_submitting), CommParams.HTTP_SEND_MSG, NoHttpRuquestFactory.create_Comment_me(userEntity.getUser_id() + "", fromUserID + "", content), httpCallback);
...
//            }
            ...
            Toast.makeText(CommentActivity.this, getString(com.VitaBit.VitaBit.R.string.general_network_faild), Toast.LENGTH_LONG).show();
        }
    }
...
//                    遍历list 判断是否保存过
    ...
    private void QueryFeedbackReply() {
        ...
        if (MyApplication.getInstance(CommentActivity.this).isLocalDeviceNetworkOk()) {
            //查询详细消息
            CallServer.getRequestInstance().add(CommentActivity.this, getString(com.VitaBit.VitaBit.R.string.general_submitting), CommParams.HTTP_CHECK_MSG, NoHttpRuquestFactory.message_details(fromUserID + "", userEntity.getUser_id() + ""), HttpCallback1);
        } else {
            MyToast.show(CommentActivity.this, getString(com.VitaBit.VitaBit.R.string.smssdk_network_error), Toast.LENGTH_LONG);
        }
        ...
        public void onSucceed(int what, Response<String> response) {
            ...
            if (!(CommonUtils.isStringEmpty(value) || ToolKits.isJSONNullObj(value))) {
                ...
                if (what == CommParams.HTTP_CHECK_MSG) {
                    ...
                    // 得到userChat后设置消息已读
                    CallServer.getRequestInstance().add(CommentActivity.this, getString(com.VitaBit.VitaBit.R.string.general_submitting), CommParams.HTTP_CHANGE_MSG_READ, NoHttpRuquestFactory.change_unread(strings), HttpCallback1);
