package com.VitaBit.VitaBit.basic;
...
public class CustomProgressBar extends View {
    ...
    public CustomProgressBar(Context context, AttributeSet attrs,int defStyleAttr) {
        ...
        this.context = context;
        DEFAULT_PROGRESS_COLOR =context.getResources().getColor(com.VitaBit.VitaBit.R.color.progress_color);
        TypedArray a = context.obtainStyledAttributes(attrs, com.VitaBit.VitaBit.R.styleable.CustomProgressBar);
        try {
            mMax = a.getInt(com.VitaBit.VitaBit.R.styleable.CustomProgressBar_max, DEFAULT_MAX);
            mProgress = a.getInt(com.VitaBit.VitaBit.R.styleable.CustomProgressBar_progress, DEFAULT_PROGRESS);
            mRadius = (int) a.getDimension(com.VitaBit.VitaBit.R.styleable.CustomProgressBar_progressRadius, DEFAULT_RADIUS);
            mProgressColor = a.getColor( com.VitaBit.VitaBit.R.styleable.CustomProgressBar_progressColor,DEFAULT_PROGRESS_COLOR);
            mProgressDescColor = a.getColor(com.VitaBit.VitaBit.R.styleable.CustomProgressBar_progressDescColor, DEFAULT_PROGRESS_DESC_COLOR);
            mBorderWidth = (int) a.getDimension(com.VitaBit.VitaBit.R.styleable.CustomProgressBar_ProgressBar_borderWidth,DEFAULT_BORDER_WIDTH);
            mProgressDesc = a.getString(com.VitaBit.VitaBit.R.styleable.CustomProgressBar_progressDesc);
            mIsShowDesc = a.getBoolean(com.VitaBit.VitaBit.R.styleable.CustomProgressBar_isShowDesc,DEFAULT_ISSHOWDESC) ;
...
//        mPaint.setShadowLayer(1,1,1,Color.WHITE);
        mPaint.setColor(context.getResources().getColor(com.VitaBit.VitaBit.R.color.progress_color_gray));
