package com.VitaBit.VitaBit.basic.toolbar;
...
//        requestWindowFeature(Window.FEATURE_NO_TITLE);// 例
    ...
    public void onCreateCustomToolBar(Toolbar toolbar){
        ...
        getLayoutInflater().inflate(com.VitaBit.VitaBit.R.layout.toobar_layout, toolbar) ;
        title = (TextView) toolbar.findViewById(com.VitaBit.VitaBit.R.id.title);
        //暂时用不到 gone掉
        btn = (Button) toolbar.findViewById(com.VitaBit.VitaBit.R.id.id_txt_btn);
        final Drawable upArrow = getResources().getDrawable(com.VitaBit.VitaBit.R.drawable.abc_ic_ab_back_mtrl_am_alpha);
        upArrow.setColorFilter(getResources().getColor(com.VitaBit.VitaBit.R.color.white), PorterDuff.Mode.SRC_ATOP);
